...
def new_post():
    ...
    return render_template('create_post.html', title='New Post',
                           legend="Create New Post", form=form)
...
def user_posts(username):
    ...
    return render_template("user_post.html", posts=posts, user=user, title=user.username)
...
{url_for('reset_token', token=token, _exteral=True)}
